...
public class CD {
	...
	public boolean etreAvant(CD autre) {
		return this.nomCD.compareToIgnoreCase(autre.nomCD) < 0;
	}


	public boolean etreAvantArtiste(CD autre) {
		return this.nomArtiste.compareToIgnoreCase(autre.nomArtiste) < 0;
	}
